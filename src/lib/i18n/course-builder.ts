...
const deExtras: CourseBuilderExtras = {
  ...
  access: {
    ...
    status: "Status",
    visibility: "Sichtbarkeit",
    lessonsInOrder: "Nach vorheriger Lektion freischalten",
  },
  analytics: {
    title: "Kursstatistik",
...
const enExtras: CourseBuilderExtras = {
  ...
  access: {
    ...
    status: "Status",
    visibility: "Visibility",
    lessonsInOrder: "Unlock after previous lesson",
  },
  analytics: {
