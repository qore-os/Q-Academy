...
export type CourseSupportCopy = {
  ...
  diff: {
    groups: Record<"course" | "goals" | "authors" | "widgets" | "modules" | "access" | "lessons" | "pages" | "blocks", string>;
...
const de: CourseSupportCopy = {
  ...
  diff: {
    groups: { course: "Kursinformation", goals: "Lernziele", authors: "Autoren", widgets: "Widgets", modules: "Module", access: "Zugriff", lessons: "Lektionen", pages: "Seiten", blocks: "Inhaltsblöcke" },
...
const en: CourseSupportCopy = {
  ...
  diff: {
    groups: { course: "Course information", goals: "Learning objectives", authors: "Authors", widgets: "Widgets", modules: "Modules", access: "Access", lessons: "Lessons", pages: "Pages", blocks: "Content blocks" },
...
const it: CourseSupportCopy = {
  ...
  diff: {
    groups: { course: "Informazioni corso", goals: "Obiettivi didattici", authors: "Autori", widgets: "Widget", modules: "Moduli", access: "Accesso", lessons: "Lezioni", pages: "Pagine", blocks: "Blocchi di contenuto" },
...
const es: CourseSupportCopy = {
  ...
  diff: {
    groups: { course: "Informacion del curso", goals: "Objetivos de aprendizaje", authors: "Autores", widgets: "Widgets", modules: "Modulos", access: "Acceso", lessons: "Lecciones", pages: "Paginas", blocks: "Bloques de contenido" },
...
const fr: CourseSupportCopy = {
  ...
  diff: {
    groups: { course: "Informations du cours", goals: "Objectifs pedagogiques", authors: "Auteurs", widgets: "Widgets", modules: "Modules", access: "Acces", lessons: "Lecons", pages: "Pages", blocks: "Blocs de contenu" },
