...
const de: CourseSupportCopy = {
  common: {
    backToCourse: "Zurueck zum Kurs", cancel: "Abbrechen", save: "Speichern", delete: "Loeschen", edit: "Bearbeiten", closeDialog: "Dialog schliessen", moveUp: "Nach oben", moveDown: "Nach unten", active: "Aktiv", invited: "Eingeladen", disabled: "Deaktiviert", teamMember: "Teammitglied", required: "Pflicht", live: "Live", draft: "Entwurf", uncategorized: "Ohne Kategorie", notAssigned: "Nicht zugewiesen",
    permission: { none: "Kein Kurszugriff", view: "Ansehen", edit: "Bearbeiten", manage: "Veroeffentlichen" },
    courseStatus: { draft: "Entwurf", published: "Veroeffentlicht", archived: "Archiviert" },
  },
  ...
  creation: {
    eyebrow: "Kursverwaltung", title: "Neuen Kurs anlegen", close: "Dialog schliessen", mode: "Erstellungsmodus", manual: "Manuell", aiAssistant: "KI-Assistent", courseTitle: "Kurstitel", courseTitlePlaceholder: "z. B. KI fuer den Vertrieb", description: "Kurzbeschreibung", descriptionPlaceholder: "Was lernen Mitglieder in diesem Kurs?", category: "Kategorie", noCategory: "Ohne Kategorie", creating: "Wird angelegt", createCourse: "Kurs anlegen", topic: "Thema", topicPlaceholder: "z. B. Sicherer KI-Einsatz im Kundenservice", audience: "Zielgruppe", audiencePlaceholder: "z. B. Teamleitungen ohne KI-Erfahrung", learningGoal: "Lernziel", learningGoalPlaceholder: "Welches konkrete Ergebnis sollen Lernende erreichen?", level: "Niveau", levels: { beginner: "Grundlagen", intermediate: "Fortgeschritten", advanced: "Experte", mixed: "Gemischt" }, tone: "Tonalitaet", tones: { practical: "Praxisnah", professional: "Professionell", motivating: "Motivierend", concise: "Kompakt" }, scope: "Umfang", scopes: { compact: "Kompakt - 2 Module", standard: "Standard - 3 Module", intensive: "Intensiv - 4 Module" }, generating: "Entwurf wird erstellt", generate: "Entwurf erstellen",
  },
  team: {
    eyebrow: "Kursbezogene Teamrechte", description: "Owner und Admins besitzen immer volle Rechte. Hier werden nur explizite Trainerrechte verwaltet.", assigned: (count) => `${count} zugewiesen`, columns: { trainer: "Trainer", status: "Status", permission: "Kursrecht", action: "Aktion" }, permissionFor: (name) => `Kursrecht fuer ${name}`, save: "Speichern", emptyTitle: "Noch keine Trainer vorhanden", emptyDescription: "Lege zuerst ein Trainerkonto in der Mitgliederverwaltung an.", manageMembers: "Mitglieder verwalten",
  },
  accessPage: { eyebrow: "Modulzugriffe", summary: (modules, members) => `${modules} Module | ${members} aktive Einschreibungen`, unpublishedNotice: "Overrides koennen erst gegen eine veroeffentlichte Kursversion gesetzt werden." },
  access: {
    title: "Individueller Modulzugriff", openCount: (count) => `${count} offen`, openRequests: "Offene Anfragen", noMessage: "Keine Nachricht.", noRequests: "Keine offenen Zugriffsanfragen.", approvalNote: "Begruendung (optional)", rejectionNote: "Ablehnungsgrund", accessUntil: "Zugriff bis", approve: "Freigeben", reject: "Ablehnen", setOverride: "Override setzen", noLearners: "Keine aktiven Lernenden.", learner: "Lernende Person", state: "Zugriff", states: { available: "Verfuegbar", read_only: "Nur Lesen", locked: "Gesperrt", hidden: "Ausgeblendet" }, expiresAt: "Ablaufdatum", reason: "Begruendung", saveOverride: "Override speichern", activeOverrides: "Aktive Overrides", until: (date) => `bis ${date}`, noExpiry: "ohne Ablaufdatum", remove: "Entfernen", noOverrides: "Keine individuellen Overrides.",
  },
  preview: {
    backToList: "Zurueck zur Kursliste", backToEditor: "Zurueck zum Kurseditor", eyebrow: "Mitglieder-Vorschau", lessonCount: (count) => `${count} Lektionen`, content: "Kursinhalt", noProgress: "Ansicht ohne Lernfortschritt", structure: "Vorschau-Kursstruktur", lessonPages: "Lektionsseiten", mainContent: "Hauptinhalt", emptyArea: "Noch keine Inhalte in diesem Bereich", noLessonsTitle: "Dieser Kurs hat noch keine Lektionen", noLessonsDescription: "Lege im Editor das erste Modul und eine Lektion an.",
    fallbacks: { eyebrow: "Kicker", heading: "Ueberschrift", text: "Text", form: "Formular", formUnavailable: "Formular nicht verfuegbar", info: "Hinweis", checklist: "Checkliste", submission: "Abgabe", contentElement: (type) => `Inhaltselement: ${type}` },
  },
  information: { goals: "Lernziele", addGoal: "Lernziel hinzufuegen", goal: (number) => `Lernziel ${number}`, deleteGoal: (number) => `Lernziel ${number} loeschen`, authors: "Kursautoren", authorSelect: "Teammitglied als Kursautor", addAuthor: "Kursautor hinzufuegen", removeAuthor: (name) => `${name} als Kursautor entfernen` },
  gallery: { display: "Darstellung", grid: "Raster", featured: "Hervorgehoben", image: (number) => `Galeriebild ${number}`, remove: (label) => `${label} entfernen`, altText: "Alternativtext", caption: "Bildunterschrift", addImage: "Bild hinzufuegen" },
  widgets: {
    title: "Kurs-Widgets", createAria: "Widget anlegen", createTitle: "Widget anlegen", types: { author: "Autor-Karte", info: "Info-Karte", image_link: "Bild-Karte" }, teamMember: "Teammitglied", noActiveMember: "Kein aktives Teammitglied", role: "Rolle", roleHint: "Leer lassen, um den Jobtitel zu verwenden.", rolePlaceholder: "Kursleitung", description: "Beschreibung", descriptionHint: "Leer lassen, um die Profilbeschreibung zu verwenden.", titleField: "Titel", text: "Text", optionalLink: "Link (optional)", internalLinkHint: "Interner Pfad oder HTTP(S)-URL.", imageSource: "Bildquelle", imageSourceHint: "Geprueftes Bild hochladen oder sicheren /images-Pfad bzw. HTTPS-URL verwenden.", altText: "Alternativtext", link: "Link", authorFallback: "Kursautor:in", cancel: "Abbrechen", create: "Widget anlegen", saveChanges: "Aenderungen speichern", saveFailed: "Das Kurs-Widget konnte nicht gespeichert werden.", moveUp: (type) => `${type} nach oben`, moveDown: (type) => `${type} nach unten`, editWidget: (type) => `${type} bearbeiten`, deleteWidget: (type) => `${type} loeschen`, confirmDelete: "Dieses Widget wirklich loeschen?", empty: "Noch keine Kurs-Widgets",
  },
  media: {
    selectFile: "Datei auswaehlen", microphoneRecording: "Mikrofonaufnahme", cameraRecording: "Kamera oder Bildschirm aufnehmen", recordingRejected: "Die Aufnahme konnte nicht uebernommen werden.", genericMedium: "Kursmedium", preparing: "Wird vorbereitet", uploading: (progress) => `Upload ${progress} %`, processing: "Sicherheitspruefung", ready: "Geprueft und bereit", remove: (name) => `${name} entfernen`, source: (label) => `${label}-Quelle`, upload: "Upload", uploadLabel: (label) => `${label} hochladen`, library: "Mediathek", useLibrary: "Geprueftes Medium wiederverwenden", searchLibrary: "Mediathek durchsuchen", emptyLibrary: "Keine passenden geprueften Medien.", selectLibraryAsset: (name) => `${name} auswaehlen`, stock: "Stock", useStock: "Stockbild verwenden", url: "URL", externalUrl: (label) => `Externe ${label}-URL verwenden`, urlLabel: (label) => `${label}-URL`, searchStock: "Stockbilder suchen", search: "Suchen",
    errors: { remove: "Das Medium konnte nicht entfernt werden.", invalidFile: "Dateityp oder Dateigroesse ist ungueltig.", wrongKind: "Die Datei passt nicht zum ausgewaehlten Blocktyp.", upload: "Upload fehlgeschlagen.", library: "Die Mediathek konnte nicht geladen werden.", stockSearch: "Stockbilder konnten nicht geladen werden.", stockUnavailable: "Stockbildsuche ist auf diesem System nicht konfiguriert.", stockSelect: "Stockbild konnte nicht ausgewaehlt werden." },
  },
  categories: {
    title: "Kategorien", manageTitle: "Kategorien verwalten", count: (count) => `${count} Kategorien`, courseCount: (count) => `${count} Kurse`, create: "Kategorie anlegen", createTitle: "Kategorie anlegen", editTitle: "Kategorie bearbeiten", close: "Dialog schliessen", name: "Name", description: "Beschreibung", color: "Farbe", colorAria: "Kategoriefarbe", cancel: "Abbrechen", save: "Speichern", saving: "Wird gespeichert", edit: "Bearbeiten", delete: "Loeschen", moveUp: "Nach oben", moveDown: "Nach unten", empty: "Noch keine Kategorien", noDescription: "Keine Beschreibung", confirmTitle: "Kategorie loeschen", confirmQuestion: (name) => `${name} wirklich loeschen?`, confirmUnused: "Diese Kategorie ist keinem Kurs zugeordnet.", confirmUsed: (count) => `${count} Kurse verwenden diese Kategorie. Sie werden ohne Kategorie weitergefuehrt.`, confirmDelete: "Endgueltig loeschen",
  },
  changes: {
    kind: { added: "Hinzugefuegt", updated: "Geaendert", removed: "Entfernt", moved: "Verschoben" }, publishing: "Wird veroeffentlicht", publishCourse: "Kurs veroeffentlichen", publishVersion: "Version veroeffentlichen", unavailableTitle: "Vergleich derzeit nicht verfuegbar", unavailableDescription: "Die aktuelle veroeffentlichte Version konnte nicht sicher gelesen werden. Es wurde keine neue Version erzeugt.", noChangesTitle: "Keine offenen Aenderungen", noChangesDescription: "Entwurf und aktuelle Version sind identisch.", total: (count) => `${count} Aenderungen`, newCount: (count) => `${count} neu`, updatedCount: (count) => `${count} bearbeitet`, removedCount: (count) => `${count} entfernt`, movedCount: (count) => `${count} verschoben`, emailPreview: "Vorschau der Modulfreigabe-E-Mails", emailSummary: (recipients, eligible, modules) => `${recipients} von ${eligible} berechtigten Mitgliedern erhalten eine E-Mail zu ${modules} neu zugaenglichen Modulen.`, noNewModules: "Diese Veroeffentlichung gibt fuer berechtigte Mitglieder keine neuen Module frei.", emailsDisabled: "Automatische Release-E-Mails sind in den Kursinformationen deaktiviert.", versionNote: "Versionshinweis", versionPlaceholder: "Was wurde in dieser Version verbessert?", publishVisibility: "Erst die Veroeffentlichung macht diese Aenderungen fuer Mitglieder sichtbar.", publishPermission: "Nur mit Veroeffentlichungsrecht", noVersionsTitle: "Noch keine Versionen", noVersionsDescription: "Die erste Veroeffentlichung startet die Versionshistorie.", version: (version) => `Version ${version}`, published: "Veroeffentlicht", saved: "Gespeichert", noVersionNote: "Kein Versionshinweis hinterlegt.", current: "Aktuell", viewChanges: "Aenderungen ansehen", comparisonUnavailable: "Vergleich nicht verfuegbar", updateCourse: "Kurs aktualisieren", publishChanges: "Aenderungen veroeffentlichen", versionHistory: "Versionshistorie", eyebrow: "Kurs-Changelog", dialogTitle: "Versionen und Aenderungen", views: "Changelog-Ansichten",
  },
  actions: {
    course: { invalidTitle: "Der Kurstitel ist zu kurz.", invalidDescription: "Bitte eine kurze Beschreibung ergaenzen.", categoryUnavailable: "Die gewaehlte Kategorie ist nicht verfuegbar.", createFailed: "Der Kurs konnte nicht angelegt werden. Bitte erneut versuchen.", publishedFromAdmin: "Ueber die Admin-Oberflaeche veroeffentlicht.", changesPublishedFromAdmin: "Aenderungen ueber die Admin-Oberflaeche veroeffentlicht." },
    ai: { invalidBrief: "Bitte die Angaben fuer den Kursentwurf pruefen.", categoryUnavailable: "Die gewaehlte Kategorie ist nicht verfuegbar.", unavailable: "Die KI-Kurserstellung ist gerade nicht verfuegbar. Bitte erneut versuchen.", inProgress: "Eine KI-Kurserstellung laeuft bereits. Bitte warte, bis sie abgeschlossen ist.", quota: (minutes) => `Das KI-Kontingent ist erreicht. Bitte in ${minutes} Minuten erneut versuchen.`, authorizationChanged: "Deine Berechtigung zur Kurserstellung wurde geaendert. Es wurde kein Entwurf gespeichert.", saveFailed: "Der Kursentwurf konnte nicht gespeichert werden. Bitte erneut versuchen.", notificationTitle: "KI-Kursentwurf erstellt", notificationBody: (title) => `Der Entwurf \"${title}\" ist bereit zur Pruefung.`, trueLabel: "Wahr", falseLabel: "Falsch" },
    category: { invalid: "Kategorie ist ungueltig.", createSuccess: "Kategorie wurde angelegt.", updateSuccess: "Kategorie wurde gespeichert.", deleteSuccess: "Kategorie wurde geloescht.", usageLoaded: "Aktuelle Kursbelegung geladen.", reorderSuccess: "Reihenfolge wurde gespeichert.", reorderInvalid: "Die Kategorienreihenfolge ist ungueltig.", failed: "Die Kategorieaktion konnte nicht abgeschlossen werden." },
    widget: { invalidCourse: "Kurs ist ungueltig.", invalidWidget: "Kurs-Widget ist ungueltig.", invalidOrder: "Widget-Reihenfolge ist ungueltig.", createSuccess: "Kurs-Widget angelegt.", updateSuccess: "Kurs-Widget gespeichert.", deleteSuccess: "Kurs-Widget geloescht.", reorderSuccess: "Widget-Reihenfolge gespeichert.", failed: "Das Kurs-Widget konnte nicht gespeichert werden." },
    access: { learnerOnlyRequest: "Nur Lernende koennen einen Modulzugriff anfragen.", learnerOnlyWithdraw: "Nur Lernende koennen eine Anfrage zurueckziehen.", invalidInput: "Eingaben pruefen.", invalidRequest: "Die Anfrage ist ungueltig.", requestSent: "Zugriffsanfrage gesendet.", requestFailed: "Die Zugriffsanfrage konnte nicht gesendet werden.", requestWithdrawn: "Zugriffsanfrage zurueckgezogen.", withdrawFailed: "Die Anfrage konnte nicht zurueckgezogen werden.", invalidDecision: "Bitte pruefe Entscheidung und Ablaufdatum.", staleRejected: "Die veraltete Anfrage wurde sicher abgelehnt.", approved: "Modulzugriff freigegeben.", rejected: "Zugriffsanfrage abgelehnt.", decisionFailed: "Die Anfrage konnte nicht entschieden werden.", invalidOverride: "Bitte pruefe Status, Begruendung und Ablaufdatum.", overrideSaved: "Individuellen Modulzugriff gespeichert.", overrideSaveFailed: "Der Modulzugriff konnte nicht gespeichert werden.", overrideRemoved: "Individuellen Modulzugriff entfernt.", overrideRemoveFailed: "Der Modulzugriff konnte nicht entfernt werden." },
  },
  diff: {
    groups: { course: "Kursinformation", goals: "Lernziele", authors: "Autoren", widgets: "Widgets", modules: "Module", access: "Zugriff", sections: "Sektionen", lessons: "Lektionen", pages: "Seiten", blocks: "Inhaltsbloecke" },
    blockTypes: { heading: "Ueberschrift", text: "Text", rich_text: "Rich-Text", button: "Button", gallery: "Galerie", callout: "Hinweisbox", quote: "Zitat", divider: "Trennlinie", accordion: "Akkordeon", tabs: "Tabs", columns: "Spalten", download: "Download", code: "Code", table: "Tabelle", data_form: "Formular", info: "Hinweis", checklist: "Checkliste", image: "Bild", video: "Video", audio: "Audio", file: "Datei", embed: "Embed", multiple_choice: "Multiple Choice", true_false: "Wahr/Falsch", multi_select: "Mehrfachauswahl", fill_blank: "Lueckentext", ordering: "Sortierung", submission: "Abgabe" },
    fields: { categoryId: "Kategorie", title: "Kurstitel", slug: "Kursadresse", shortDescription: "Kurzbeschreibung", description: "Beschreibung", coverImage: "Titelbild", difficulty: "Schwierigkeitsgrad", estimatedMinutes: "Geschaetzte Dauer", certificateEnabled: "Zertifikat", featured: "Hervorhebung", visibleInCatalog: "Katalogsichtbarkeit", showProgressPercentage: "Fortschrittsanzeige", notifyMembersOnModuleRelease: "E-Mail bei Modulfreigabe" },
    draftCreated: "Kursentwurf erstellt", noPublishedVersion: "Noch keine Version veroeffentlicht", changed: (label) => `${label} geaendert`, courseInformation: "Kursinformation", fallback: { goal: "Lernziel", author: "Autor", authorWidget: "Autoren-Widget", widget: "Widget", module: "Modul", section: "Sektion", lesson: "Lektion", page: "Seite", block: "Inhaltsblock" },
    details: { goalRemoved: "Lernziel entfernt", goalAdded: "Lernziel hinzugefuegt", textChanged: "Text geaendert", orderChanged: "Reihenfolge geaendert", authorRemoved: "Autor entfernt", authorAdded: "Autor hinzugefuegt", authorProfileChanged: "Autorenprofil geaendert", widgetRemoved: "Widget entfernt", widgetAdded: "Widget hinzugefuegt", widgetContentChanged: "Widget-Inhalt geaendert", moduleRemoved: "Modul entfernt", moduleAdded: "Modul hinzugefuegt", moduleContentChanged: "Modulinhalt geaendert", moduleTypeChanged: "Modultyp geaendert", linkedCourseChanged: "Verlinkter Zielkurs geaendert", orderAndIndentChanged: "Reihenfolge und Einrueckung geaendert", indentChanged: "Einrueckung geaendert", moduleAccessChanged: "Modulzugriff geaendert", sectionSettingsChanged: "Sektionseinstellungen geaendert", lessonSettingsChanged: "Lektionseinstellungen geaendert", pageSettingsChanged: "Seiteneinstellungen geaendert" },
    from: (name) => `Aus ${name}`, in: (name) => `In ${name}`, on: (name) => `Auf ${name}`, blockRemoved: (location) => `${location} entfernt`, blockAdded: (location) => `${location} hinzugefuegt`, blockContentChanged: (location) => `Inhalt geaendert - ${location}`,
  },
};
...
> = {
  de: {
    picker: "Kategoriefarbe auswaehlen",
