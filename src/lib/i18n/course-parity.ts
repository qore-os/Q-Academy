...
export type SectionVisibilityActionCode =
  | "section_visibility.invalid_input"
  | "section_visibility.section_unavailable"
  | "section_visibility.permission_denied"
  | "section_visibility.conflict"
  | "section_visibility.failed"
...
export type CourseParityCopy = {
  ...
  visibility: {
    group: (section: string) => string;
    actions: Record<"visible" | "draft" | "coming_soon", string>;
    labels: Record<"visible" | "draft" | "coming_soon", string>;
    genericFailure: string;
    empty: string;
    updated: (count: number, visibility: string) => string;
    action: Record<Exclude<SectionVisibilityActionCode, "section_visibility.updated">, string>;
  };
  cover: {
    label: string;
...
const de: CourseParityCopy = {
  ...
  visibility: { group: (section) => `Sichtbarkeit aller Lektionen in ${section}`, actions: { visible: "Alle Lektionen sichtbar schalten", draft: "Alle Lektionen als Entwurf ausblenden", coming_soon: "Alle Lektionen auf Erscheint bald setzen" }, labels: { visible: "Sichtbar", draft: "Entwurf", coming_soon: "Erscheint bald" }, genericFailure: "Die Sichtbarkeit konnte nicht geaendert werden.", empty: "Die Sektion enthaelt keine Lektionen.", updated: (count, visibility) => `${count} ${count === 1 ? "Lektion" : "Lektionen"} auf ${visibility} gesetzt.`, action: { "section_visibility.invalid_input": "Die Sichtbarkeit ist ungueltig.", "section_visibility.section_unavailable": "Diese Sektion ist in dem Kurs nicht verfuegbar.", "section_visibility.permission_denied": "Du darfst diese Sektionslektionen nicht bearbeiten.", "section_visibility.conflict": "Die Sektionslektionen wurden gleichzeitig geaendert. Lade die Seite neu.", "section_visibility.failed": "Die Sichtbarkeit konnte nicht geaendert werden." } },
...
const en: CourseParityCopy = {
  ...
  visibility: { group: (section) => `Visibility of all lessons in ${section}`, actions: { visible: "Make all lessons visible", draft: "Hide all lessons as drafts", coming_soon: "Set all lessons to coming soon" }, labels: { visible: "Visible", draft: "Draft", coming_soon: "Coming soon" }, genericFailure: "Visibility could not be changed.", empty: "This section contains no lessons.", updated: (count, visibility) => `${count} ${count === 1 ? "lesson" : "lessons"} set to ${visibility}.`, action: { "section_visibility.invalid_input": "The visibility value is invalid.", "section_visibility.section_unavailable": "This section is unavailable in the course.", "section_visibility.permission_denied": "You cannot edit the lessons in this section.", "section_visibility.conflict": "The section lessons changed at the same time. Reload the page.", "section_visibility.failed": "Visibility could not be changed." } },
...
const it: CourseParityCopy = {
  ...
  visibility: { group: (section) => `Visibilita di tutte le lezioni in ${section}`, actions: { visible: "Rendi visibili tutte le lezioni", draft: "Nascondi tutte le lezioni come bozze", coming_soon: "Imposta tutte le lezioni su Prossimamente" }, labels: { visible: "Visibile", draft: "Bozza", coming_soon: "Prossimamente" }, genericFailure: "Non e stato possibile modificare la visibilita.", empty: "Questa sezione non contiene lezioni.", updated: (count, visibility) => `${count} ${count === 1 ? "lezione impostata" : "lezioni impostate"} su ${visibility}.`, action: { "section_visibility.invalid_input": "Il valore di visibilita non e valido.", "section_visibility.section_unavailable": "Questa sezione non e disponibile nel corso.", "section_visibility.permission_denied": "Non puoi modificare le lezioni di questa sezione.", "section_visibility.conflict": "Le lezioni della sezione sono state modificate contemporaneamente. Ricarica la pagina.", "section_visibility.failed": "Non e stato possibile modificare la visibilita." } },
...
const es: CourseParityCopy = {
  ...
  visibility: { group: (section) => `Visibilidad de todas las lecciones de ${section}`, actions: { visible: "Mostrar todas las lecciones", draft: "Ocultar todas las lecciones como borradores", coming_soon: "Marcar todas las lecciones como Proximamente" }, labels: { visible: "Visible", draft: "Borrador", coming_soon: "Proximamente" }, genericFailure: "No se pudo cambiar la visibilidad.", empty: "Esta seccion no contiene lecciones.", updated: (count, visibility) => `${count} ${count === 1 ? "leccion configurada" : "lecciones configuradas"} como ${visibility}.`, action: { "section_visibility.invalid_input": "El valor de visibilidad no es valido.", "section_visibility.section_unavailable": "Esta seccion no esta disponible en el curso.", "section_visibility.permission_denied": "No puedes editar las lecciones de esta seccion.", "section_visibility.conflict": "Las lecciones de la seccion cambiaron al mismo tiempo. Recarga la pagina.", "section_visibility.failed": "No se pudo cambiar la visibilidad." } },
...
const fr: CourseParityCopy = {
  ...
  visibility: { group: (section) => `Visibilite de toutes les lecons de ${section}`, actions: { visible: "Rendre toutes les lecons visibles", draft: "Masquer toutes les lecons comme brouillons", coming_soon: "Marquer toutes les lecons comme Bientot disponible" }, labels: { visible: "Visible", draft: "Brouillon", coming_soon: "Bientot disponible" }, genericFailure: "La visibilite n'a pas pu etre modifiee.", empty: "Cette section ne contient aucune lecon.", updated: (count, visibility) => `${count} ${count === 1 ? "lecon definie" : "lecons definies"} sur ${visibility}.`, action: { "section_visibility.invalid_input": "La valeur de visibilite n'est pas valide.", "section_visibility.section_unavailable": "Cette section n'est pas disponible dans le cours.", "section_visibility.permission_denied": "Vous ne pouvez pas modifier les lecons de cette section.", "section_visibility.conflict": "Les lecons de la section ont ete modifiees simultanement. Rechargez la page.", "section_visibility.failed": "La visibilite n'a pas pu etre modifiee." } },
